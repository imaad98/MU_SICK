...
<body>
		...
		<div class="container">
			<div class="banner-text">
				<div class="slider-info text-right">
					...
					<p class="text-white">Are you (Mu)Sick?<br/>
						Upload Your MoM (Music of Media) here and get featured.</p>
	...
	<section class="wthree-row" id="about">
		<div class="row justify-content-center align-items-center no-gutters abbot-main">
			<div class="col-lg-6 p-0">
				<img src="images/billie.jpeg" class="img-fluid" alt="" />
			</div>
			<div class="col-lg-6 abbot-right px-md-5  py-lg-0 py-3">
				<div class="card">
					<div class="card-body px-lg-5">
						<h3 class="stat-title card-title align-self-center mb-sm-5 mb-3">(Mu)Sick
							<br> get addicted to music</h3>
						<span class="w3-line"></span>
						<p class="card-text align-self-center my-4 text-white">
							Are you a singer?...But afraid to sing in front of a huge crowd.Then you are in the right place.Upload your songs to (Mu)Sick and let the people listen to your songs and rate it.
						</p>
						<p class="card-text align-self-center mb-5 text-white">Be the part of (Mu)Sick.Upload your songs and get featured by greate musicians.</p>
	...
	<div class="contact-top text-center" id="more_info">
		<div class="content-contact-top">
			...
			<p class="text-white w-75 mx-auto">(Mu)Sick a unique platform for upcoming singers.
			</p>
		</div>
	</div>
	<!-- //contact top -->
				...
				<div class="col-lg-6 contact-bottom d-flex flex-column contact-right-w3ls">
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>email</h6>
								<p>
									<a href="mailto:example@email.com" class="text-dark">yamum@musick.com</a>
								</p>
							</div>
						</div>
					</div>
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>address</h6>
								<p>Bermuda Traingle | Illumanit's Pussy</p>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="cpy-right text-center">
		<p>© 2049 (Mu)Sick. All rights reserved</p>
	</div>
	<!-- //copyright -->
